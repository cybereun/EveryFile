...
2. 일반 설치는 `EveryFile-Setup-v1.0.3.exe`를 실행합니다.
3. 무설치 사용은 `EveryFile-Portable-v1.0.3.zip`을 쓰기 가능한 폴더에 압축 해제한 뒤
...
Run `EveryFile-Setup-v1.0.3.exe` for a per-user installation, or extract
`EveryFile-Portable-v1.0.3.zip` and launch `EveryFile.exe` without installation.
